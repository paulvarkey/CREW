def Run_Bulldozer_Action(agent, action):
    """
    Convert high-level bulldozer actions into low-level environment actions.
    ...
    match action.type:
        ...
        # Move towards location while cutting
        case 2:
            return [1, int(action.param_1), int(action.param_2)]
